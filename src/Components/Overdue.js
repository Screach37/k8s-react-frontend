                    ...
                    <>
                     <div key={index} className='card mt-3 p-3 border-0'>
                       <div className='' style={{ display:"flex", alignItems:'center', justifyContent:"space-between" }} >
                         ...
                         <p className='px-3 p-1 sub-assi-txt' style={{ color:"#FF0E0E", fontSize:14, fontWeight:400, backgroundColor:"#FFE1E1", borderRadius:5 }} >Unpaid</p>
                       </div>
                       <div className='text-start m-0' style={{ color:"#545454", fontSize:26, fontWeight:600, fontFamily:'inter' }} >₹ {item.emi_amount}</div>
                        ...
                        <div className='py-2 d-flex align-items-center' >
                           ...
                           <div className='sub-assi-txt ps-3' style={{ fontSize:16, fontWeight:400, color:"#FF0E0E", fontFamily:'inter' }} >{item.description}</div>
                        </div>
