            ...
            <div className='card py-2 rounded-0 border-0'>
             <div className='row py-3'>
                <div style={{ display:"flex", justifyContent:"", alignItems:"center" }}>
                  ...
                  <span className='assi-nav-txt' style={{ fontWeight:600, fontSize:20, paddingLeft:10  }}>Exam Details</span>
                </div>
              </div>
            </div> 
          </div>
          ...
          <div className='card px-3'>
           <div className='row mt-3'>
             ...
             <div className='col-4 text-start'>
               ...
               <div className="" style={{ color:"#1E1E1E", fontSize:20, fontWeight:600 }}>NA</div>
             </div>
            </div>
            <div className="text-start" style={{ color:"#1E1E1E", fontSize:20, fontWeight:600 }}>Instructor’s Note</div>
            <div className="text-start" style={{ color:"#7E7E7E", fontSize:20, fontWeight:600 }}>NA</div>
          </div> 
        </div>
       </div>
      </div>
