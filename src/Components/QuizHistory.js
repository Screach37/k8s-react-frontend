                              ...
                              <div className='card p-3 border-0 mb-3'>
                               <div className='text-start py-2 assi-declr-txt' style={{ fontSize:20, fontWeight:600, fontFamily:'inter' }}>{item.title}</div>
                                ...
                                <div className='d-flex justify-content-evently align-items-center py-1' >
                                   ...
                                   <div className='ps-2 sub-assi-txt' style={{ fontSize:18, fontWeight:500, color:"#858585", fontFamily:"inter" }}>{item.subjectname}</div>
                                </div>
                                <div className='d-flex justify-content-evently align-items-center py-1' >
                                ...
                                <div className='mb-3 mt-2' style={{ width:"100%", height:8, backgroundColor:"#F1F1F1" }} >
                                 ...
                                 <NavLink to="/Result" className="text-decoration-none" >
                                   <div className='col-12 py-2' style={{ border:'1px solid #ED7A2B', color:"#ED7A2B", borderRadius:5, fontFamily:'inter' }} >View Result</div>
                                 </NavLink>
                                 </div>
                              </div>
                            </div> 
        ...
        <div className='mx-4' style={{ width:"100%", backgroundColor:'#fff', justifyContent:"center", alignItems:'center', display:"flex", borderTop:Location.pathname=="/CourseHistory"?"2px solid #ED7A2B":"", color:'#ED7A2B' }}>
          <NavLink to='/CourseHistory' className="text-decoration-none text-dark" >
           <div style={{  }}>
             ...
             <div style={{ color:Location.pathname=="/CourseHistory"?"#ED7A2B":"#B4B4B4", fontSize:14 }} >Classs</div>
           </div>
         </NavLink>
         </div>
