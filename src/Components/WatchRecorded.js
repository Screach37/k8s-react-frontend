...
export default function WatchRecorded() {
  ...
  return (
    <div>
      ...
      <div className='py-4' style={{ width:"100%", backgroundColor:"#ED7A2B", borderRadius:5, display:"flex", alignItems:'center', justifyContent:"center", cursor:"pointer", color:"#fff", fontSize:20 }} ><BsFillRecord2Fill style={{ fontSize:35 }} />&nbsp; Watch Recording</div>
      </div>
    </div>
  )
}
